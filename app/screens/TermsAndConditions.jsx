...
Unauthorised use of this website may give rise to a claim for damages and/or be a criminal offence.</Text>
            ...
            { !this.props.route.params.accepted && <TouchableOpacity disabled={ !this.state.accepted } onPress={() => this.props.navigation.navigate('Register', {accepted: true})} style={ this.state.accepted ? styles.button : styles.buttonDisabled }><Text style={styles.buttonLabel}>Accept</Text></TouchableOpacity>}
            { !this.props.route.params.accepted && <TouchableOpacity onPress={() => this.props.navigation.navigate('Register', {accepted: false})} style={ styles.buttonDecline }><Text style={styles.buttonLabel}>Decline</Text></TouchableOpacity>}
            { this.props.route.params.accepted && <TouchableOpacity disabled={ false } onPress={() => this.props.navigation.navigate('Register')} style={ styles.button}><Text style={styles.buttonLabel}>Back to Register</Text></TouchableOpacity>}
      </View>
    );
  }
